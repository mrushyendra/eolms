(function (a) {
    elFinder = function (d, g) {
        ...
        this.drop = function (l, j, k) {
            ...
            var i = [];
            j.helper.find('div:not(.noaccess):has(>label):not(:has(em[class="readonly"],em[class=""]))').each(
    ...
    elFinder.prototype.ui.prototype.commands = {
        ...
        rm: function (c) {
            ...
            this.exec = function () {
                ...
                if (g.length) {
                    this.fm.lockShortcuts(true);
                    a('<div><div class="ui-state-error ui-corner-all"><span class="ui-icon ui-icon-alert"/><strong>' + this.fm.i18n("Are you shure you want to remove files?<br /> This cannot be undone!") + "</strong></div></div>").dialog({
        ...
        upload: function (c) {
            ...
            this.exec = function () {
                var g = "el-finder-io-" + (new Date().getTime()),
                    ...
                    q = a('<p class="el-finder-add-field"><span class="ui-state-default ui-corner-all"><em class="ui-icon ui-icon-circle-plus"/></span>' + this.fm.i18n("Add field") + "</p>").click(function () {
                ...
                k = a(k + "</form>");
                o.append(k.append(l.hide()).prepend(h).append(q)).dialog({
                    dialogClass: "el-finder-dialog",
                ...
                function n() {
                    var t = a('<iframe name="' + g + '" name="' + g + '" src="about:blank"/>'),
                        u = t[0],
                        i = 50,
                        s, e, r;
                    t.css({
