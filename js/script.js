$(document).ready(function() {
	...
	var $content = $('#content');
		...
		/*----------------------------------------------------------------------*/
		/* THE BELOW SEEMS TO BE REDUNDANT
		...
		*/
		...
		/* Clickable headers
		/*----------------------------------------------------------------------*/
		$("label.toggleable").click(
			function() {
				$(this).parent().children().each(
					function(index,value) {
						if (!$(value).hasClass("toggleable")) $(value).toggle("fast");
					}
				);
			}
		);
		...
		$(document).ready(
			function () {
				$("label.toggleable").each(
					function (index,value) {
						if ($(value).hasClass("off")) {
							$(value).parent().children().each(
								function(idx,val) { if (!$(val).hasClass("toggleable")) $(val).hide("fast"); }
							)
						}
					}
				);				
